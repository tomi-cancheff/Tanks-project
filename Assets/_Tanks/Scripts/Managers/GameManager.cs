...
namespace Tanks.Complete
{
    public class GameManager : MonoBehaviour
    {
        ...
        [SerializeField] private string[] m_Levels = { "Level_Desert", "Level_Jungle" }; //Lista para aleatorizar los niveles al jugar.
                                                                                         // Variable para recordar el último nivel cargado
        private int m_LastLevelIndex = -1; // -1 significa que no hay uno previo
        ...
        private IEnumerator GameLoop ()
        {
            ...
            if (m_GameWinner != null)
            {
                ...
                // Suponiendo exactamente dos niveles en m_Levels
                string nextLevel;
                if (current == m_Levels[0])
                    nextLevel = m_Levels[1];
                else
                    nextLevel = m_Levels[0];
